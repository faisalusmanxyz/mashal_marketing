...
class _FormScreenState extends State<FormScreen> {
                  ...
                  children: [
                    ...
                    TextFormField(
                        validator: MultiValidator([
                          RequiredValidator(
                              errorText: 'Name Applicant field is required'),
                        ...
                        decoration:
                            textFieldDecoration(label: "Name of Applicant")),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                      validator: RequiredValidator(
                          errorText: "CNIC Applicant field is Required"),
                      controller: personalCnicApplicantController,
                      keyboardType: TextInputType.number,
                      decoration:
                          textFieldDecoration(label: "CNIC of Applicant"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    ...
                    TextFormField(
                        validator: RequiredValidator(
                            errorText: "Maling Address field is Required"),
                        controller: personalMalingAddressController,
                        decoration:
                            textFieldDecoration(label: "Maling Address ")),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                        validator: RequiredValidator(
                            errorText: "parmanent Address field is Required"),
                        controller: personalParmanentAddressController,
                        decoration:
                            textFieldDecoration(label: "Parmanent Address ")),
                    const SizedBox(
                      height: 10,
                    ),
                    const SizedBox(
                    ...
                    TextFormField(
                      ...
                      decoration: textFieldDecoration(label: "Phone No"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                      validator:
                          RequiredValidator(errorText: "Res field is Required"),
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Row(
                                  children: [
                                    Checkbox(
                                        value: names[index][society[index]],
                                        onChanged: (valu) {
                                          names[index][society[index]] = valu;
                                          setState(() {});
                                        }),
                    ...
                    TextFormField(
                      ...
                      decoration: textFieldDecoration(label: "Nominee Name"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                      ...
                      decoration: textFieldDecoration(label: "Nominee CNIC"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                      ...
                      decoration: textFieldDecoration(label: "S/O, D/O, W/O"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    TextFormField(
                      ...
                      decoration:
                          textFieldDecoration(label: "CNIC of S/O, D/O, W/O"),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    ...
                    TextFormField(
                        validator: RequiredValidator(
                            errorText: "Area (Marla) field is Required"),
                        controller: plotAreaController,
                        decoration: textFieldDecoration(label: "Area (Marla)")),
                    const SizedBox(
                      height: 10,
                    ),
                    Center(
  ...
  Future<void> formValidate() async {
    ...
    SocietyModel societyForm = SocietyModel(
        ...
        nomineeType: nomineeSoController.text.trim(),
